...
use Rutatiina\Bill\Traits\InventoryReverse as TxnTraitsInventoryReverse;
...
class Update
{
    ...
    public function run()
    {
        ...
        $Txn = Bill::with('items', 'ledgers', 'debit_account', 'credit_account')->find($this->txn['id']);
