...
trait Validate
{
    ...
    private function validate()
    {
        ...
        $customMessages = [
            'debit_financial_account_code.required' => "The Billing Account is required.",
        ];
        ...
        $this->settings = BillRecurringSetting::with(['financial_account_to_debit', 'financial_account_to_credit'])->first();
        ...
        $last_txn = BillRecurring::latest()->first();
