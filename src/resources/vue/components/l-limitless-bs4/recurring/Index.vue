        ...
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><i class="icon-drawer3 mr-2"></i> <span class="font-weight-semibold">Recurring Bills</span></h4>
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item active">Recurring Bills</span>
                    </div>
...
<script>
    ...
    export default {
        name: 'AccountingSalesRecurringBills',
        //components: {},
        data() {
            return {}
        },
        ...
        methods: {
            onRowClick(txn) {
                //console.log(txn)
                this.$router.push({ path: '/recurring-bills/'+txn.id })
            }
        },
        ready:function(){},
