    ...
    <div class="content-wrapper">
        ...
        <div class="page-header page-header-light d-print-none">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><i class="icon-files-empty2 mr-2"></i> <span class="font-weight-semibold">Bill</span></h4>
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item active">Bill</span>
                    </div>
        ...
        <div class="content border-0 p-0">
            ...
            <div class="content" v-if="!this.$root.loadingTxn && txnData">
                    ...
                    <div class="card-header header-elements-inline d-print-none text-danger">
                        ...
                        <div class="header-elements">
                            <button type="button"
                                    ...
                                    @click="txnApprove('/bills/'+txnData.id+'/approve')"><i class="icon-printer mr-2"></i> Click here to Approve</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="card max-width-960 m-auto rg-print-border-0" v-if="!this.$root.loadingTxn">
                    ...
                    <div class="card-header bg-transparent header-elements-inline d-print-none">
                        ...
                        <div class="header-elements">
                            ...
                            <router-link :to="'/bills/'+$route.params.id+'/edit'"
                                         class="btn btn-light btn-sm">
                                <i class="icon-pencil mr-2"></i>
                                Edit
                            </router-link>

                            <router-link :to="'/bills/'+$route.params.id+'/copy'"
                        ...
                        <div class="d-md-flex flex-md-wrap">
                            <div class="mb-4 mb-md-2">
                                ...
                                <ul v-if="txnData.contact" class="list list-unstyled mb-0">
                                    <li><h5 class="my-2">{{txnData.contact.contact_salutation}} {{txnData.name}}</h5></li>
                ...
                <!-- payments made / settlements-->
                <div class="row">

                    <div class="col-lg-12 max-width-960 m-auto p-0">
                        <div v-for="annex in txnData.annexes"
                             v-if="annex.name === 'settlement'"
                             class="card border-left-3 border-left-success rounded-left-0 mt-2">
                            <div class="card-body">
                                <div class="d-sm-flex align-item-sm-center flex-sm-nowrap">
                                    <div>
                                        <h6 class="font-weight-semibold">{{annex.remittance.contact_name}}</h6>
                                        <ul class="list list-unstyled mb-0">
                                            <li>Date: <span class="text-semibold">{{annex.remittance.date}}</span></li>
                                            <li>Receipt #: &nbsp;{{annex.remittance.number}}</li>
                                            <li>Reference: <span class="text-semibold">{{annex.remittance.reference}}</span></li>
                                        </ul>
                                    </div>

                                    <div class="text-sm-right mb-0 mt-3 mt-sm-0 ml-auto">
                                        <h6 class="font-weight-semibold">{{rgNumberFormat(annex.remittance.total, 2)}} {{annex.remittance.base_currency}}</h6>
                                        <ul class="list list-unstyled mb-0">
                                            <li>Method: <span class="font-weight-semibold">{{annex.remittance.payment_mode}}</span></li>
                                            <li>Account: <span class="text-semibold"> {{annex.remittance.credit_account.name}}</span></li>
                                            <li class="dropdown">
                                                Status: &nbsp;
                                                <span class="badge bg-success-400 align-top font-weight-bold">Completed</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="card-footer d-sm-flex justify-content-sm-between align-items-sm-center">
										<span>
											...
											{{annex.remittance.items[0].name}}
											<span class="font-weight-semibold">Payment Voucher</span>
										</span>

                                <ul class="list-inline list-inline-condensed mb-0 mt-2 mt-sm-0">
                                    <li class="list-inline-item">
                                        <a :href="'/receipts/'+annex.remittance.id" class="text-default"><i class="icon-eye8"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
