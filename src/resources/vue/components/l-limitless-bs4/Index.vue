        ...
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><i class="icon-drawer3 mr-2"></i> <span class="font-weight-semibold">Bills</span></h4>
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item active">Bills</span>
                    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            onRowClick(txn) {
                //console.log(txn)
                this.$router.push({ path: '/bills/'+txn.id })
            }
        },
        ready:function(){},
