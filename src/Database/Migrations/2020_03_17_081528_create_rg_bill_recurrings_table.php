...
class CreateRgBillRecurringsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('tenant')->create('rg_bill_recurrings', function (Blueprint $table) {
    ...
    {
        Schema::connection('tenant')->dropIfExists('rg_bill_recurrings');
    }
}
