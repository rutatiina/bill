...
class CreateRgBillsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('tenant')->create('rg_bills', function (Blueprint $table) {
    ...
    {
        Schema::connection('tenant')->dropIfExists('rg_bills');
    }
}
