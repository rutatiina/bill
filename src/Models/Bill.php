...
class Bill extends Model
{
    ...
    {
        return $this->hasMany('Rutatiina\Bill\Models\BillItem', 'bill_id')->orderBy('id', 'asc');
    }

    public function ledgers()
    {
        return $this->hasMany('Rutatiina\Bill\Models\BillLedger', 'bill_id')->orderBy('id', 'asc');
    }

    public function comments()
    {
        return $this->hasMany('Rutatiina\Bill\Models\BillComment', 'bill_id')->latest();
    }
    ...
    {
        return $this->hasMany('Rutatiina\Bill\Models\BillItemTax', 'bill_id', 'id');
    }
